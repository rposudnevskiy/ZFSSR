...
from xapi.storage.libs.libzfs import utils, qmp
from xapi.storage.libs.libzfs.utils import mkdir_p
...
class Qemudisk(object):
    ...
    def open(self, dbg):
        ...
        try:
            ...
            log.debug("%s: qemudisk.Qemudisk.open: ZFS ZVol Image opened: %s" % (dbg, args))
        except Exception:
